              ...
              <AnimateOnScroll variant="fade-in-left">
                <div className="flex flex-col gap-4 ">
                  <p>
                    ...
                    simplemente porque quería aprender a crear. Esa iniciativa
                    me llevó a mi primer gran proyecto en la universidad:
                    construir un dispensador de comida para perros, donde
                    aprendí a llevar una solución completa de la idea al
                    prototipo usando PHP.
                  </p>
                  <p>
                    Fue ahí donde descubrí que una buena lógica de backend
                    necesitaba una gran interfaz. Me sumergí en el frontend,
                    aprendiendo CSS a fondo, hasta que una prueba técnica para
                    mis prácticas me lanzó de lleno al mundo de C# y .NET.
                    Aunque no sabía nada en ese momento, investigué, saqué la
                    prueba y confirmé mi pasión por la robustez del backend.
                  </p>
                  <p>
                    Hoy, combino esa base sólida con mi interés por las
                    experiencias de usuario modernas, por lo que decidí dar el
                    siguiente paso en mi carrera aprendiendo React. Busco un
                    lugar donde pueda integrar mi viaje full-stack, mi capacidad
                    para aprender bajo presión y mi pasión por construir.
                  </p>
                </div>
              </AnimateOnScroll>
            </div>
